...
const PlayerTable = ({players, option, imageFormater}) => {
  return (<div>
    <BootstrapTable data={players.sort((a,b) => {return a.rank - b.rank})} pagination={true} striped hover containerStyle={{width:'150%', overflowX: 'scroll'}} bordered={true} >
